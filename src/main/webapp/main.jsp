...
<head>
    ...
    <title>Geolocation-based Searching of Legacy PDF Documents</title>
      ...
      function writeAddressName(latLng) {
        ...
        function(results, status) {
          ...
          if (status == google.maps.GeocoderStatus.OK){
            ...
            //look for separate address components
  ...
  <body>
    <h1>Geolocation-based Searching of Legacy PDF Documents</h1>
    <div id="map"></div>
